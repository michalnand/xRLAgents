...
class AgentDiffExpCausal(): 
    def __init__(self, envs, Config, Model):
        ...
        self.log_loss_causality = ValuesLogger("loss_causality")
    ...
    def get_logs(self):
        ...
        logs = [self.log_rewards_int, self.log_loss_ppo, self.log_loss_diffusion, self.log_loss_causality, self.log_loss_im_ssl]
    ...
    def train(self): 
        ...
        for e in range(self.training_epochs):
            for batch_idx in range(batch_count):
                ...
                # total loss    
                loss = loss_ppo + loss_diffusion + loss_causality + loss_ssl
                ...
                self.log_loss_causality.add("loss_causality", loss_causality.float().detach().cpu().numpy())
                self.log_loss_causality.add("accuracy", accuracy)
    ...
    def _im_causality(self, states_prev, states_now):
        ...
        print(causality.shape, labels.shape)
