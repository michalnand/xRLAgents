...
class AgentDiffExpAdvA(): 
    def __init__(self, envs, Config, Model):
        ...
        self.top_n_count            = config.top_n_count
        ...
        self.episodic_buffer   = EpisodicBuffer(self.buffer_size, self.top_n_count, (512, ))
        ...
        print("top_n_count          ", self.top_n_count)
    ...
    def step(self, states, training_enabled):     
        ...
        # episodic internal motivation
        rewards_int_b = self.episodic_buffer.step(z.detach().cpu())
        ...
        if training_enabled:   
            ...
            if self.trajectory_buffer.is_full():
                ...
                self.log_rewards_int.add("mean", rewards_int_scaled.mean().item())
                self.log_rewards_int.add("std",  rewards_int_scaled.std().item())
