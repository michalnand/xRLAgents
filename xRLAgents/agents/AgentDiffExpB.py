...
class AgentDiffExpB(): 
    def __init__(self, envs, Config, Model):
        ...
        self.reward_int_min_coeff   = config.reward_int_min_coeff
        self.reward_int_max_coeff   = config.reward_int_max_coeff
        ...
        print("reward_int_min_coeff ", self.reward_int_min_coeff)
        print("reward_int_max_coeff ", self.reward_int_max_coeff)
    ...
    def step(self, states, training_enabled):     
        ...
        self._update_episode_score(rewards_ext, dones)
        ...
        reward_int_coeff    = a*self.reward_int_min_coeff + (1.0 - a)*self.reward_int_max_coeff
        ...
        self.log_rewards_int.add("episode_score_mean", self.episode_score.mean())
        self.log_rewards_int.add("episode_score_std", self.episode_score.std())
        self.log_rewards_int.add("episode_score_min", self.episode_score.min())
        self.log_rewards_int.add("episode_score_max", self.episode_score.max())
    ...
    def _update_episode_score(self, rewards, dones):
