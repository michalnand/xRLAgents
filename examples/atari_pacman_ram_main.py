...
if __name__ == "__main__":
    ...
    # create result path
    result_path = "results/" + env_name + "_ram/"
    
    
    # create environments
    print("creating envs")
    envs = rl_libs.EnvsListParallel(env_name, n_envs, Wrapper=WrapperAtariRam)

    print("creating agent")
    # create agent
    agent = rl_libs.AgentPPO(envs, rl_libs.ModelRLTransformer, gamma = 0.99, entropy_beta = 0.001, n_steps = 128, batch_size = 256)
